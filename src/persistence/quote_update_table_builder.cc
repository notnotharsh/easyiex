...
void QuoteUpdateTableBuilder::Flush() {
    ...
    std::shared_ptr<arrow::Array> timestamps, symbol_ids, bid_sizes, bid_prices, ask_prices, ask_sizes;
    ...
    auto table = arrow::Table::Make(schema_, {timestamps, BuildSymbolColumn(symbol_ids), bid_sizes, bid_prices, ask_prices, ask_sizes});
