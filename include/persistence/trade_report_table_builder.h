...
class TradeReportTableBuilder {
    ...
    private:
        ...
        arrow::UInt32Builder sizes_builder;
        arrow::Int64Builder prices_builder;
        arrow::Int64Builder trade_ids_builder;
        arrow::UInt8Builder sale_condition_flags_builder;
